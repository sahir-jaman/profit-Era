                  ...
                  children: [
                    ...
                    Container(
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(model.shortInfo,style: TextStyle(color: Colors.white,fontSize: 12.0),),
                          )
                        ],
                      ),
                    ),
                        ...
                        decoration: BoxDecoration(
                          ...
                          child: Center(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  "50%",style: TextStyle(fontSize: 15.0,color: Colors.white,fontWeight: FontWeight.bold),
                                ),
                                Text(
                                  "OFF",style: TextStyle(fontSize: 12.0,color: Colors.white,fontWeight: FontWeight.bold),
